...
const handCheck = async (dealerCard, myCards, callbackOnResolve, isSecondHand) => {
    ...
    let stackedAdjustedCombination = {
        pairCombination: structuredClone(pairCombination),
        hasAceCombination: structuredClone(hasAceCombination),
        normalCombination: structuredClone(normalCombination)
    }
...
const inertButton = () => {
    ...
    console.log("auto gambling manual_card_count_v17 inserted")
}
