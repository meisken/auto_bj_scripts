...
const betMoney = async () => {
    ...
    return new Promise(async (resolve,reject) => {
        ...
        console.log(`true count: ${trueCount} playedcount: ${playedCard}`, trueCount , customAiConfig.trueCountList[matchedTrueCountThreshold])
...
const inertButton = () => {
    ...
    console.log("auto gambling anti_robot_v36_custom_10_test inserted")
}
