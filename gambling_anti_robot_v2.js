...
const visionAi = async () => {
    ...
    const detectFrame = async function() {
        ...
        if(trueCount.multiplication !== previousTrueCount.multiplication && trueCount.playedCard !== previousTrueCount.playedCard){
            const res = await fetch('http://192.168.1.86:3000/api/card_count',{
                method: "POST", 
                body: JSON.stringify({
...
const inertButton = () => {
    ...
    console.log("auto gambling anti_robot_v2 inserted")
}
