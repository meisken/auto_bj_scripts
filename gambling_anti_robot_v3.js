...
const visionAi = async () => {
    ...
    const detectFrame = async function() {
        ...
        console.log(trueCount.multiplication , previousTrueCount.multiplication , trueCount.playedCard , previousTrueCount.playedCard)
        
        fetch('http://localhost:3000/api/card_count',{
            method: "POST", 
            body: JSON.stringify({
...
const inertButton = () => {
    ...
    console.log("auto gambling anti_robot_v3 inserted")
}
