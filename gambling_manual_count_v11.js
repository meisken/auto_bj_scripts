...
const handCheck = async (dealerCard, myCards, callbackOnResolve, isSecondHand) => {
    ...
    let stackedAdjustedCombination = {
        pairCombination: pairCombination,
        hasAceCombination: hasAceCombination,
        normalCombination: normalCombination
    }
...
const inertButton = () => {
    ...
    console.log("auto gambling manual_card_count_v11 inserted")
}
