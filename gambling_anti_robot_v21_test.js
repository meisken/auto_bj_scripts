...
const yoloVision = () => {
    ...
    const handleRedDetected =  () => {
        ...
        if( cardCount.playedCard > 150){
            clearTimeout(redAppearTimer);
            redAppearTimer = setTimeout(() => {
                resetCardCount()
            },2000)
...
const visionAi = async () => {
    ...
    const detectFrame = async function() {
        ...
        console.log(cardCount, getCurrentTrueCount())
...
const storeCardCountingHistory = () => {
    if(currentHands !== 0){
        console.log("store card count data")
...
const inertButton = () => {
    ...
    console.log("auto gambling anti_robot_v21_test inserted")
}
