...
const visionAi = async () => {
    ...
    const detectFrame = async function() {
        ...
        const video = document.querySelector("#fmp4-video");
        if(!(video && video.readyState >= 3)) return optimizedAnimationFrame(detectFrame)
        ...
        try{
            ...
            console.log(predictions,RedCardPredictions)
...
const betMoney = async () => {
    ...
    return new Promise(async (resolve,reject) => {
        ...
        adjustedFrequency = adjustedFrequency * config[Math.floor(trueCount)];
        console.log("frequency",adjustedFrequency,Math.floor(trueCount))
...
const inertButton = () => {
    ...
    console.log("auto gambling V53_origin inserted")
}
