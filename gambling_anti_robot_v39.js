...
const inertButton = () => {
    ...
    console.log("auto gambling anti_robot_v39 inserted")
}
...
const loadVisionModel = () => {
    ...
    return new Promise(async (resolve, reject) => {
        try{
            ...
            const remoteModelUrl = "https://cdn.statically.io/gh/meisken/cdn_script/main/vision_model/RED_CARD_V3/model.json"
